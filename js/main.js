...
(function () {
    ...
    SelfExclusion.$inject = ["$scope", "$state", "$translate", "alertService", "websocketService", "accountService", "validationService"];

    function SelfExclusion($scope, $state, $translate, alertService, websocketService, accountService, validationService) {
        var vm = this;
        vm.hasError = false;
        vm.validation = validationService;
